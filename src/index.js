...
app.use(
  ...
  proxy(API_SERVER, {
    ...
    //   opts.headers['x-forwarded-host'] = 'https://mysterious-shelf-99391.herokuapp.com';
    //   return opts;
    // }
}));
...
app.get('*', async (req, res) => {
  ...
  */
  ...
  .map(promise => { // interating through all to-be rendered components loadData funtions
    if(promise){
